...
;(function(factory) {
    if (typeof define === 'function' && define['amd'])
        define(['knockout', 'ko-grid', 'ko-grid-paging', 'ko-grid-view-state-storage', 'ko-data-source', 'ko-indexed-repeat', 'ko-grid-view-modes'], factory);
    else
        window['ko-grid-height-adjuster'] = factory(window.ko, window.ko.bindingHandlers['grid']);
